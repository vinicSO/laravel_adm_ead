...
@section('title', mb_strtoupper($module->name) . " | Detalhes da Aula " . mb_strtoupper($lesson->name))

@section('content')
<h1 class="w-full text-3xl text-black pb-6">
    Detalhes da Aula {{ $module->name }}
</h1>

<div class="flex flex-wrap">
    <div class="w-full my-6 pr-0 lg:pr-2">
        <div class="leading-loose">
            <form class="p-10 bg-white rounded shadow-xl" action="{{ route('lessons.destroy', ['module_id' => $module->id, 'lesson' => $lesson->id]) }}" method="POST">
                <ul>
